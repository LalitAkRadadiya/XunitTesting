...
namespace TESTING.CLPMT.BAL.Database
{
    public static class PassengerRepository
    {
        ...
        {
            AddPassenger(new Passenger { Number = Guid.NewGuid(), FirstName = "Lalit1", LastName = "Radaiya1", ContactNo = "123245" });
            AddPassenger(new Passenger { Number = Guid.NewGuid(), FirstName = "Lalit2", LastName = "Radaiya2", ContactNo = "123245" });
            AddPassenger(new Passenger { Number = Guid.NewGuid(), FirstName = "Lalit3", LastName = "Radaiya3", ContactNo = "123245" });
        }
