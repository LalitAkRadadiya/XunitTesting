...
namespace TESTING.CLPMT.TEST
{
    public class PassengerControllerTest
    {
        ...
        private static IList<Passenger> GetPassengers()
        {
            ...
            {
                new Passenger(){ Number=Guid.NewGuid(),FirstName="Lalit1",LastName="Radaiya1",ContactNo="12324"},
                new Passenger(){ Number=Guid.NewGuid(),FirstName="Lalit2",LastName="Radaiya2",ContactNo="12324"},
                new Passenger(){ Number=Guid.NewGuid(),FirstName="Lalit3",LastName="Radaiya3",ContactNo="12324"}
            };
            return passengers;
        }
    }
